...
import kr.ac.hansung.demap.ui.nickname.NickNameContract
import kr.ac.hansung.demap.ui.nickname.NickNamePresenter
...
val presenterModule = module {
    ...
    factory<NickNameContract.Presenter> { (view: NickNameContract.View) -> NickNamePresenter(view, get()) }
