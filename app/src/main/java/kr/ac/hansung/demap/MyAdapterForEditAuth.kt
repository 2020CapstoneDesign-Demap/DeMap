...
class MyAdapterForEditAuth(context: Context, resource: Int, item_edit_auth: Array<String>, item_edit_desc: Array<String>) : BaseAdapter() {
    private val mContext = context
    private val mItem_pub = item_edit_auth // 수정 권한
    private val mItem_desc = item_edit_desc // 수정 권한 설명
